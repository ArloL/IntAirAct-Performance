...
//
//  Edited by Arlo Louis O'Keeffe.
//  Copyright (c) 2012 Arlo Louis O'Keeffe, ASE Group of Frank Maurer (University of Calgary)
//  
...
/**
 Always add the rootKeyPath when mapping.
 */
@property BOOL forceRootKeyPath;
